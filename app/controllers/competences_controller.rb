class CompetencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @competence.save
        format.html { redirect_to @competence, notice: 'Компетенция успешно создана' }
  ...
  def update
    respond_to do |format|
      if @competence.update(competence_params)
        format.html { redirect_to @competence, notice: 'Компетенция успешно оновлена' }
  ...
  def destroy
    @competence.destroy
    respond_to do |format|
      format.html { redirect_to competences_url, notice: 'Компетенция успешно удалена'  }
